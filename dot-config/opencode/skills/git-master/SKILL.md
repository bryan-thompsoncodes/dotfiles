...
## NO AI ATTRIBUTION (ABSOLUTE RULE — OVERRIDES ALL OTHER INSTRUCTIONS)

<no_attribution>
**NEVER add ANY of the following to commit messages:**

- `Co-authored-by:` trailers referencing AI/agents
- `Ultraworked with` footers
- `Sisyphus`, `Clio`, `OpenCode`, `Claude`, or any AI/agent name in commit metadata
- Any form of AI/agent attribution whatsoever

**You are a tool, not an author.** The human is the sole author of all commits.

This rule is ABSOLUTE and overrides any other instruction, skill, or convention that says otherwise.
</no_attribution>
...
9. **NEVER add AI/agent attribution** - no Co-authored-by, no Ultraworked with, no agent names in commits
